# checkout — Closure Sheet

- **Current level:** L2 (blocked)
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** sessions, events, scoring, chat, offers, dashboard read model
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Fechar rotas legadas abertas, especialmente sessão, decisão, regras e `orders/complete`; confiar somente em carrinho/frete/pagamento server-side; concluir desacoplamento por eventos.
- **Blocked by:** [P0 blockers](./p0-blockers.md) — P0.7 (rotas legadas), P0.1/P0.3 (tenant).
