# Widget: accessibility — Closure Sheet

- **Current level:** L1-L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** keyboard, focus, dialog semantics, axe gate
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Focus trap/restauração, Escape, semântica de dialog, alvos de toque e gate axe sem violações críticas.
