# buyer-purchase-history — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** buyer personalization per merchant
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Persistir identidade hoje em memória; escrita idempotente/event-driven; retenção de PII e teste de restart.
