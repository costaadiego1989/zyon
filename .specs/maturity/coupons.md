# coupons — Closure Sheet

- **Current level:** L1
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P3
- **Included flows:** merchant coupon management and redemption
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Proteger controller merchant; Prisma; limite atômico por buyer; idempotência concorrente; resgate no fechamento do pedido.
- **Note:** Só entra no escopo do piloto quando o caminho P1 estiver L3.
