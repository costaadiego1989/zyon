# Widget: auth-buyer-hub — Closure Sheet

- **Current level:** L1-L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** buyer auth and buyer hub
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Remover bearer token do `localStorage`; separar buyer/merchant; expiração, refresh, revogação e E2E de sessão vencida.
