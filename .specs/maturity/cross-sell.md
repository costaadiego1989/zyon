# cross-sell — Closure Sheet

- **Current level:** L1
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P3
- **Included flows:** eligible cross-sell suggestions per merchant
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Proteger controller merchant; persistir promoções/sugestões; catálogo real; isolamento tenant e E2E de conversão.
