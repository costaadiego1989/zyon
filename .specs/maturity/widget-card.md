# Widget: card — Closure Sheet

- **Current level:** L1 (critical)
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** card payment UI
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Substituir `CardForm` ativo, que envia PAN/CVV ao backend, por tokenização provider-side/Stripe Elements; confirmar apenas por webhook.
- **Critical:** Bloqueado por [P0.8](./p0-blockers.md) — formulário PAN/CVV deve ser desativado até tokenização segura.
