# Widget: pix — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** PIX payment UI
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Estado pendente, expiração e atualização por polling/SSE/webhook; confirmação não otimista; smoke real.
