# Widget: shell-embed — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** shell and embed bootstrap
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Token obrigatório no piloto; validar claims; Shadow DOM ou isolamento equivalente; CSP e teste contra CSS hostil.
