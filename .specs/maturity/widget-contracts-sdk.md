# Widget: contracts-sdk — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** runtime schemas, SDK, contract tests
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Schemas runtime como fonte única; contract tests; SDK cobrir cupom/cross-sell e contratos versionados.
