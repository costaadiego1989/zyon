# shipping — Closure Sheet

- **Current level:** L1
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** shipping quote and selection
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Exigir embed/tenant confiável; não aceitar regra comercial do browser; persistir quote/seleção/expiração; smoke de carrier.
