...
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** merchant registration, JWT login, auth cookie
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Remover segredo padrão fora de dev; refresh rotativo/revogável; rate limit compartilhado; RBAC e abuso em E2E.
