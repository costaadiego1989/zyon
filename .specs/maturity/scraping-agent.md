# scraping-agent — Closure Sheet

- **Current level:** L0-L1
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P4
- **Included flows:** external source scraping, purchase agent
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Autenticação/rate limit; fila e worker; fontes reais permitidas; persistência; timeout/circuit breaker e compra auditável.
