# agent-rules — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** agent identity, capabilities, guardrails
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Remover ownership duplicado de checkout settings; usar persistência global; autorização por papel e contrato versionado.
