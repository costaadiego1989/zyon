# Widget: theme-responsiveness — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** theming and responsive layout
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Matriz mobile/tablet, alto contraste, zoom 200%, temas piloto e orçamento de performance.
