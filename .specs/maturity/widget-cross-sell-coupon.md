# Widget: cross-sell-coupon — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P3
- **Included flows:** cross-sell and coupon UI
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Sucesso/erro explícito, prevenção de aceite duplicado, erros tipados e persistência dos módulos da API.
