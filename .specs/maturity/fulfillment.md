# fulfillment — Closure Sheet

- **Current level:** L1
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P3
- **Included flows:** tracking webhook, shipment state
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Consolidar com o shipment persistido de integrações; assinar webhook; label/tracking real; máquina de estado e E2E de entrega.
