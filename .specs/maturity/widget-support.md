# Widget: support-widget — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** support UI in widget
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Remover políticas genéricas do fallback; usar configuração merchant; SLA e notificação operacional.
