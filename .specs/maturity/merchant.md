# merchant — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** merchant rules and configuration
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Eliminar rotas paralelas abertas de regras; auditoria; autorização por papel; teste cross-tenant.
