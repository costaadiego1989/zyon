# Widget: cart — Closure Sheet

- **Current level:** L1 (critical)
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** cart line add/increment/decrement/remove
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** `+`, `-` e remoção hoje alteram somente o estado visual; criar mutação server-side e comprovar o mesmo total no pagamento.
- **Critical:** Estado de compra não pode existir somente no cliente. Bloqueia gate do piloto.
