# negotiation — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** M2M negotiation sessions and cost ledger
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Autenticação buyer/M2M correta; retirar chamada direta ao checkout; Prisma como padrão; métricas de custo e E2E live controlado.
