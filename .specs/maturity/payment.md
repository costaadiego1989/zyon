# payment — Closure Sheet

- **Current level:** L2 (blocked)
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** Asaas payment intents and webhooks
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Proteger endpoint legado; impedir fallback fake em produção; confirmação somente por estado autoritativo/webhook; reconciliação, refund e smoke sandbox.
- **Blocked by:** [P0 blockers](./p0-blockers.md) — P0.5 (fallbacks), P0.7 (legado), P0.8 (cartão PAN/CVV).
