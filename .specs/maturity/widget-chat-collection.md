# Widget: chat-collection — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** chat and data collection
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Timeout/abort/backoff; retry idempotente; schemas por campo; consentimento e telemetria de falha.
