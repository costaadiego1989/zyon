# integrations — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** tenant integrations, delivery, secrets, retries/DLQ
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Claim/lock de delivery; proteção SSRF; criptografia/rotação de segredos; scopes em leitura; alertas de retry/DLQ.
