# Widget: confirmation — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** order confirmation screen
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Usar `order_id`, recibo e status final retornados pela API, não referência derivada da sessão.
