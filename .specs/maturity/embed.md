...
- **Owner:** TBD
- **Priority:** P1
- **Included flows:** storefront embed session tokens
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Aplicar `allowedOrigin`, `scopes` e `cartRef`; nonce/replay; CORS/CSP; remover modo sem token do piloto.
- **Blocked by:** [P0 blockers](./p0-blockers.md) — P0.6 (CORS), P0.7 (rotas).
