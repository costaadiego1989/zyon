# checkout-settings — Closure Sheet

- **Current level:** L2
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P2
- **Included flows:** widget behavior, triggers, suppression
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Tornar fonte única; registrar auditoria; fechar tasks de depreciação e validar Prisma no CI.
