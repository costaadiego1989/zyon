# self-checkout — Closure Sheet

- **Current level:** L1
- **Target level:** L3
- **Owner:** TBD
- **Priority:** P4
- **Included flows:** buyer wallet/templates, self-driven checkout
- **Excluded flows:** TBD
- **What's missing for L3 (ADR-0007):** Unificar auth com buyer-account; persistir wallet/templates; tokenizer real; executar checkout/pagamento/pedido; E2E cross-buyer.
- **Note:** Expansão pós-piloto; não deve atrasar P0/P1.
