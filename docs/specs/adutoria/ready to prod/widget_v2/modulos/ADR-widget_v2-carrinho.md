...
- [W2-007](<../ADR-widget_v2.md#w2-007>) — Alteração de carrinho não invalida sessão/intent do checkout: Preço exibido, frete selecionado e valor da intenção podem divergir; nova tentativa pode recuperar intenção antiga.
...
- W2-007: Mudar quantidade após gerar PIX exige novo total/intent válido e impede usar intenção antiga para concluir pedido alterado.
