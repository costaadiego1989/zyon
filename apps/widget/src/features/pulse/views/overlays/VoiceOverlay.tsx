  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', width: '152px', height: '152px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '30px' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: 'var(--aacp-accent, #0f766e)', filter: 'blur(9px)', opacity: 0.5 }} />
        <div
          ref={waveRef}
          style={{
            position: 'relative',
        ...
        >
          <span style={{ width: '5px', height: '58px', borderRadius: '4px', background: 'var(--aacp-accent, #0f766e)', animation: 'waveBar .9s ease-in-out infinite' }} />
          <span style={{ width: '5px', height: '58px', borderRadius: '4px', background: 'var(--aacp-accent, #0f766e)', animation: 'waveBar .9s ease-in-out .15s infinite' }} />
          <span style={{ width: '5px', height: '58px', borderRadius: '4px', background: 'var(--aacp-accent, #0f766e)', animation: 'waveBar .9s ease-in-out .3s infinite' }} />
          <span style={{ width: '5px', height: '58px', borderRadius: '4px', background: 'var(--aacp-accent, #0f766e)', animation: 'waveBar .9s ease-in-out .45s infinite' }} />
          <span style={{ width: '5px', height: '58px', borderRadius: '4px', background: 'var(--aacp-accent, #0f766e)', animation: 'waveBar .9s ease-in-out .6s infinite' }} />
        </div>
      </div>
