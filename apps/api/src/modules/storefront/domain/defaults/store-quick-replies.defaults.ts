...
export const DEFAULT_STORE_QUICK_REPLIES: StoreQuickRepliesConfig = {
  stages: [
    ...
    { stage: "categories", label: "Categorias", replies: ["Encontrar um Produto", "Categorias em Promoção"] },
    ...
    { stage: "added_to_cart", label: "Adicionado ao Carrinho", replies: ["Ver Carrinho", "Continuar Comprando", "Produtos Semelhantes", "Finalizar Compra"] },
