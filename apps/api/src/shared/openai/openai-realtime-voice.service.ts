...
function buildVoiceInstructions(input: OpenAIRealtimeVoiceSessionInput): string {
  ...
  return [
    ...
    "REGRA OBRIGATÓRIA: quando a pessoa disser finalizar pedido ou compra, pagar, ir ao checkout ou concluir, chame begin_checkout antes de responder. A ferramenta abre login quando necessário ou o checkout do comprador autenticado. Nunca colete cartão, cobre ou confirme pagamento por voz.",
