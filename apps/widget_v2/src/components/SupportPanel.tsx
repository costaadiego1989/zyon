...
export default function SupportPanel({ open, onClose }: SupportPanelProps) {
  ...
  const embedToken = api?.authToken ?? null;
  ...
  }, [ticketId, ticketToken, apiBaseUrl]);
  ...
  const getFallbackResponse = (label: string): string => {
    const responses: Record<string, string> = {
      "Prazo de entrega":
        "Nossos prazos variam de 2 a 7 dias úteis, dependendo de sua localização. Você receberá um rastreamento assim que o pedido sair do nosso centro de distribuição.",
      "Política de trocas":
        "Aceitamos trocas dentro de 30 dias da compra. O produto deve estar em perfeitas condições e com a embalagem original.",
      "Formas de pagamento":
        "Aceitamos cartão de crédito, débito, Pix, boleto e múltiplas parcelas via Asaas.",
      "Falar com atendente":
        "Um atendente humano será acionado em breve. Você será notificado quando estiver disponível.",
    };
  ...
  const sendMessage = useCallback(
    ...
    [merchantId, embedToken, apiBaseUrl],
  );
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          overflow: "hidden",
          animation: open
            ? "panelSlideUp 0.3s cubic-bezier(0.25, 1, 0.5, 1)"
            : "none",
      ...
      >
        ...
        <div
          style={{
            ...
            padding: "12px 14px",
            borderBottom:
              "1px solid var(--aacp-line, rgba(255,255,255,0.1))",
            flex: "none",
            gap: "12px",
          }}
        >
              ...
              >
                <span
                  style={{
                    ...
                    height: "4px",
                    borderRadius: "50%",
                    background: "var(--aacp-success, #34d399)",
                  }}
                />
                {agentName} · Suporte
              </div>
          ...
          <button
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.color = "var(--aacp-fg)")
            }
            onMouseLeave={(e) =>
          ...
          {view === "welcome" && messages.length === 0 ? (
            ...
            >
              ...
              <div>
                ...
                >
                  Posso ajudar com dúvidas sobre entrega, pagamento, trocas e
                  muito mais. Como posso te ajudar?
                </div>
              </div>
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (!isLoading) {
                        e.currentTarget.style.background =
                          "var(--aacp-surface-2, rgba(255,255,255,0.08))";
                    ...
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background =
                        "var(--aacp-card, rgba(255,255,255,0.05))";
                      e.currentTarget.style.borderColor =
                        "var(--aacp-line, rgba(255,255,255,0.1))";
                    }}
                  >
                    <span>{item.icon}</span>
        ...
        >
          ...
          >
            <input
              ...
              placeholder={
                isLoading ? "Aguarde..." : "Digite sua mensagem…"
              }
              disabled={isLoading}
              style={{
                flex: 1,
