...
export function merchantEndpoints(base: string, f: typeof fetch) {
  return {
    ...
    getIntentMemoryRecords(): Promise<Array<{ id: string; global_user_id: string; primary_intent: string; urgency: string; budget_tier: string; pain_points: string[]; created_at: string }>> {
