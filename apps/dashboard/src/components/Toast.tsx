      ...
      {toasts.map((toast) => (
        <div
          ...
          style={{
            ...
            padding: "12px 16px",
            borderRadius: 10,
            background: toast.type === "success" ? "var(--good-soft)" : "var(--danger-soft)",
            border: `1px solid ${toast.type === "success" ? "var(--good)" : "var(--danger)"}`,
            color: toast.type === "success" ? "var(--good)" : "var(--danger)",
