...
export function FinancePage({ apiBaseUrl, me }: { apiBaseUrl: string; me: MerchantProfile | null }) {
  ...
  return (
    <div className="page-container">
      ...
      <SidePanel isOpen={Boolean(selected)} title={selected?.kind === "refund" ? "Reembolso confirmado" : "Pedido concluído"} onClose={() => setSelected(null)}>{selected ? <TransactionDetails transaction={selected} /> : null}</SidePanel>
    </div>
  );
}
