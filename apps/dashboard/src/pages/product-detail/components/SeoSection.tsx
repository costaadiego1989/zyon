...
export function SeoSection(props: SeoSectionProps) {
  ...
  const charCount = (val: string, max: number) => {
    ...
    return <span style={{ font: "10px var(--font-mono)", color }}>{len}/{max}</span>;
  };
  ...
  return (
    <section style={{ background: "var(--surface-2)", border: "1px solid var(--color-border)", borderRadius: 14, padding: "20px 22px" }}>
      ...
      {!seoTitle && !generating && (
        <div style={{ textAlign: "center", padding: "24px 16px", color: "var(--color-text-muted)", fontSize: 12, background: "var(--surface-1)", borderRadius: 8, marginBottom: 14 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
              <span style={{ font: "600 11px var(--font-sans)", color: "var(--color-text)" }}>Título SEO</span>
            ...
            <input
              ...
              style={{ width: "100%", padding: "7px 10px", borderRadius: 7, border: "1px solid var(--color-border)", font: "12.5px var(--font-mono)", color: "var(--color-text)", outline: "none", background: "var(--surface-1)" }}
            />
          </div>

          <div>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
              <span style={{ font: "600 11px var(--font-sans)", color: "var(--color-text)" }}>Meta Description</span>
            ...
            <textarea
              ...
              rows={2}
              style={{ width: "100%", padding: "7px 10px", borderRadius: 7, border: "1px solid var(--color-border)", font: "12.5px var(--font-mono)", color: "var(--color-text)", outline: "none", background: "var(--surface-1)", resize: "vertical" }}
            />
          </div>

          <div>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
              <span style={{ font: "600 11px var(--font-sans)", color: "var(--color-text)" }}>Slug (URL)</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 0, background: "var(--surface-1)", border: "1px solid var(--color-border)", borderRadius: 7, overflow: "hidden" }}>
              <span style={{ padding: "7px 10px", font: "11px var(--font-mono)", color: "var(--color-text-faint)", background: "var(--surface-2)", borderRight: "1px solid var(--color-border)", whiteSpace: "nowrap" }}>loja.com/produto/</span>
              <input
                value={seoSlug}
                ...
                style={{ flex: 1, padding: "7px 10px", border: "none", font: "12.5px var(--font-mono)", color: "var(--color-text)", outline: "none", background: "transparent" }}
              />
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                <span style={{ font: "600 11px var(--font-sans)", color: "var(--color-text)" }}>OG Title</span>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                <span style={{ font: "600 11px var(--font-sans)", color: "var(--color-text)" }}>OG Description</span>
          ...
          <div>
            <span style={{ font: "600 11px var(--font-sans)", color: "var(--color-text)", display: "block", marginBottom: 4 }}>Keywords</span>
            <input
              ...
              style={{ width: "100%", padding: "7px 10px", borderRadius: 7, border: "1px solid var(--color-border)", font: "12.5px var(--font-mono)", color: "var(--color-text)", outline: "none", background: "var(--surface-1)" }}
            />
            <span style={{ font: "10px var(--font-mono)", color: "var(--color-text-faint)", marginTop: 2, display: "block" }}>Separe por vírgula (5-10 recomendado)</span>
          </div>
        </div>
      )}
    </section>
