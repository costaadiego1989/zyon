...
export function StepShipping({ apiBaseUrl, connected, loading, onConnect, onSkip }: StepShippingProps) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div style={{ padding: "20px 24px", borderRadius: 12, border: "1px solid var(--border)", background: "var(--card)", display: "flex", alignItems: "center", gap: 16 }}>
        <div style={{ width: 48, height: 48, borderRadius: 10, background: "color-mix(in srgb, var(--accent) 10%, transparent)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        ...
        {connected ? (
          <span style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 12, fontWeight: 600, color: "var(--accent)", padding: "6px 12px", borderRadius: 8, background: "color-mix(in srgb, var(--accent) 8%, transparent)" }}>
      ...
      <div style={{ padding: "14px 18px", borderRadius: 10, background: "var(--bg)", border: "1px solid var(--border)" }}>
      ...
      {!connected && (
        <button
          type="button"
          onClick={onSkip}
          style={{ alignSelf: "flex-start", padding: "6px 0", background: "none", border: "none", color: "var(--muted)", fontSize: 12, cursor: "pointer", textDecoration: "underline" }}
        >
