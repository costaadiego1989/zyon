        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 16 }}>
          <section style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 14, padding: "20px 22px" }}>
            ...
            <label style={{ display: "block" }}>
              <span style={{ font: "600 12px var(--sans)", color: "var(--ink)", display: "block", marginBottom: 4 }}>Categoria (ID)</span>
              <input
                value={categoryId}
              ...
              />
              <span style={{ font: "11px var(--sans)", color: "var(--faint)", marginTop: 4, display: "block" }}>Seletor de categorias será integrado em breve.</span>
            </label>
          </section>
