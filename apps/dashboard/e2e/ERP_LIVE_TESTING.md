...
1. In PowerShell, run `$env:PLAYWRIGHT_BASE_URL = "https://app.zyon-payments.com.br"; pnpm e2e:erp-live:auth`. Complete the dashboard login in the visible browser. It saves an authenticated storage state outside Git.
